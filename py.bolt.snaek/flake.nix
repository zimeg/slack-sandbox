        ...
        slackcli = pkgs.stdenv.mkDerivation {
          ...
          src =
            if pkgs.stdenv.isDarwin then
              pkgs.fetchurl {
                url = "https://downloads.slack-edge.com/slack-cli/slack_cli_3.5.0_macOS_64-bit.tar.gz";
                sha256 = "18h843x4awcl2jybr7yk33r5y41sh2fly6p6bw89pwjjzp5qz5z0";
              }
            else
              pkgs.fetchurl {
                url = "https://downloads.slack-edge.com/slack-cli/slack_cli_3.5.0_linux_64-bit.tar.gz";
                sha256 = "02d999smj2wpcs8ik2pia0q04mczp8y1y471vbvgzscv64282din";
              };
